...
import { ExcelMPSProjectAssets } from '../ExcelERPNext/ExcelMPSProjectAssets'
...
export interface Project{
	...
	/**	Notes : Text Editor	*/
	notes?: string
	/**	Actual Start Date (via Time Sheet) : Date	*/
	actual_start_date?: string
	/**	Actual Time (in Hours via Time Sheet) : Float	*/
	actual_time?: number
	/**	Actual End Date (via Time Sheet) : Date	*/
	actual_end_date?: string
	/**	Estimated Cost : Currency	*/
	estimated_costing?: number
	/**	Total Costing Amount (via Timesheets) : Currency	*/
	...
	/**	Total Billable Amount (via Timesheets) : Currency	*/
	total_billable_amount?: number
	/**	Total Billed Amount (via Sales Invoices) : Currency	*/
	...
	message?: string
	/**	MPS Project Assets : Table - Excel MPS Project Assets	*/
	excel_mps_project_assets?: ExcelMPSProjectAssets[]
}
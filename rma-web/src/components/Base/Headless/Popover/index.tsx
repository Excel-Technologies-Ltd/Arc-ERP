...
function Popover({ children, className, ...props }: ExtractProps<typeof HeadlessPopover>) {
  return (
    <HeadlessPopover as='div' className={twMerge(['relative', className])} {...props}>
      {children}
    </HeadlessPopover>
  );
}
...
Popover.Button = <C extends React.ElementType = 'div'>({
  ...
  return (
    <HeadlessPopover.Button as={as} className={twMerge(['cursor-pointer', className])} {...props}>
      {children}
